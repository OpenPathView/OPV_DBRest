...
path_edge = Table('path_edge', post_meta,
    ...
    Column('source_yaw_dest', Float, nullable=True),
    Column('source_target_yaw_dest', Float, nullable=True),
    Column('dest_yaw_source', Float, nullable=True),
    Column('dest_target_yaw_source', Float, nullable=True),
)
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['path_edge'].columns['dest_target_yaw_source'].create()
    post_meta.tables['path_edge'].columns['dest_yaw_source'].create()
    post_meta.tables['path_edge'].columns['source_target_yaw_dest'].create()
    post_meta.tables['path_edge'].columns['source_yaw_dest'].create()
...
def downgrade(migrate_engine):
    ...
    post_meta.tables['path_edge'].columns['dest_target_yaw_source'].drop()
    post_meta.tables['path_edge'].columns['dest_yaw_source'].drop()
    post_meta.tables['path_edge'].columns['source_target_yaw_dest'].drop()
    post_meta.tables['path_edge'].columns['source_yaw_dest'].drop()
